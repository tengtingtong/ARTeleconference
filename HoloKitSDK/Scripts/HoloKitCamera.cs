...
namespace HoloKit
{
    ...
    public class HoloKitCamera : MonoBehaviour
    {
        ...
        {
            //ให้ offset ของ holokit มีตำแหน่งที่เพิ่มจาก offset ของ Model และ Camera โดยจะอ้างอิงจากตำแหน่งของ Main camera
            ...
            cameraRight.transform.localPosition = new Vector3((profile.model.eyeDistance / 2f) + 0.087f, 0f, 0f);
